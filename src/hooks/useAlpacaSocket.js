/**
 * React hook — connects the Alpaca WebSocket to TanStack Query's cache.
 *
 * When the market is open, this hook:
 *   1. Opens a WebSocket to Alpaca (via createAlpacaSocket)
...
import { createAlpacaSocket } from '../services/websocket'
