...
| 2026-03-25 | **Roadmap header redesign.** Cleaned up the `/roadmap` page header area — cleaner chevron back button with hover animation, "cheechart" branding right-aligned, better spacing and typography. Progress bar: taller, darker bg for visual separation, dimmed separator. Added active node glow style in CSS. |
