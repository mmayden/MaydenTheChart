...
| 2026-03-15 | UX improvements: saved preset delete confirmation (two-click safety), rename/delete buttons always visible with larger hit targets. Terminal theme added (phosphor green #33ff33 on true black, neon green accent #00ff41) — CSS vars, Tailwind overrides, SettingsModal 3-column grid. Build clean. |
